	...
	<div class="home-intro__calendar-picker">
		<section class="home-intro__calendar-picker-inner">
			<div class="home-intro__calendar-picker-inner-input home-intro__calendar-picker-inner-input--left">
				...
				<input type="date" id="arrival" name="trip-start" value="2020-03-24" min="2023-08-01" max="2025-01-01" />
			</div>
			<div class="home-intro__calendar-picker-inner-input home-intro__calendar-picker-inner-input--right">
				...
				<input type="date" id="departure" name="trip-end" value="2020-03-30" min="2023-08-01" max="2025-01-01" />
			</div>
			<button class="home-intro__calendar-picker-button button button--beige button--auto">
				CHECK AVAILABILITY
			</button>
		</section>
	</div>
