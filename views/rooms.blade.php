...
<html lang="en">
	...
	<body>
			...
			<div class="rooms-intro__text">
				<section class="rooms-intro__head-section">
					...
					<div class="rooms-intro__breadcrumbs">
						<a href="./index.html"
							><span class="rooms-intro__breadcrumbs-home"
								>Home</span
							></a
						>
						<span class="rooms-intro__breadcrumbs-separator"
							>&nbsp|&nbsp</span
						>
						<span class="rooms-intro__breadcrumbs-about"
							>Rooms</span
						>
					</div>
				</section>
		...
		<main class="rooms-cards">
				...
				<div class="swiper-wrapper rooms-cards__wrapper">
					<div class="swiper-slide swiper-slide-rooms-cards">
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room.jpg"
							...
							<div class="rooms-cards__text-container">
								...
								<span
									class="rooms-cards__text-frist-span price-amount"
									>$345/Night</span
								>&nbsp&nbsp&nbsp&nbsp<span
									class="rooms-cards__text-second-span"
						...
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room2.jpg"
								alt="a picture of a hotel room"
							/>
							<div class="rooms-cards__card-service-info">
								<img
						...
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room3.jpg"
								alt="a picture of a hotel room"
							/>
							<div class="rooms-cards__card-service-info">
								<img
						...
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room4.jpg"
								alt="a picture of a hotel room"
							/>
							<div class="rooms-cards__card-service-info">
								<img
					...
					<div class="swiper-slide">
						...
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room6.jpg"
								alt="a picture of a hotel room"
							/>
							<div class="rooms-cards__card-service-info">
								<img
						...
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room8.jpg"
								alt="a picture of a hotel room"
							/>
							<div class="rooms-cards__card-service-info">
								<img
						...
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room9.jpg"
								alt="a picture of a hotel room"
							/>
							<div class="rooms-cards__card-service-info">
								<img
					...
					<div class="swiper-slide">
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room10.jpg"
								alt="a picture of a hotel room"
							/>
							<div class="rooms-cards__card-service-info">
								<img
						...
						<div class="rooms-cards__card">
							<img
								class="room-image"
								src="./assets/images/hotelRooms/hotel_room14.jpg"
								alt="a picture of a hotel room"
							/>
							<div class="rooms-cards__card-service-info">
								<img
			...
			<div
				id="pagination-rooms-cards"
				class="swiper-pagination-rooms-cards"
			></div>
		</main>
