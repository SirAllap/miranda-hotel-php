...
<main class="room-details-intro__room-details">
	<div class="room-details-intro__room-details-wrapper">
		...
		<img src="../assets/images/hotelRooms/hotel_room13.jpg" alt="a photo of a hotel room" />
	</div>
	<div class="room-details-intro__rooms-details-availability">
		<p>Check Availability</p>
		<label for="">Check In</label>
		<input placeholder="Fri, 14th June 2020" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" />
		<label for="">Check Out</label>
		<input placeholder="Sun, 16th June 2020" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" />
